...
<head>
    <meta charset="utf-8" />
    <title>Lothar Fernando Matheus Bastos Benmuyal</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Lothar Fernando Matheus Bastos Benmuyal" />
    <meta name="description"
        content="Portifólio de trabalhos realizados e formação deLothar Fernando Matheus Bastos Benmuyal" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profileLothar.jpg"
                            alt="Lothar Fernando Matheus Bastos Benmuyal">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Lothar Fernando Matheus Bastos Benmuyal</h4>
                        <div class="status">Engenheiro Elétrico</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/lothar-fernando-771aa9197">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/lotharbenmuyal">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/UCEMYYngACwm2NTFrO0rP5ow?view_as=subscriber">
                                    <i class="font-icon icon-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/Lotharterra1">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            lotharcontato@contato.com.br
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (63) ****-**** </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Lothar Fernando Matheus Bastos Benmuyak</footer>
                </div>
            </div>
        </div>
    </main>
